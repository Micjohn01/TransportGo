package michaelJohn.transportgo.config.security.filters;
...
import michaelJohn.transportgo.config.security.util.JwtUtil;
...
import static org.springframework.security.core.context.ObservationSecurityContextChangedListener.getAuthentication;

@AllArgsConstructor
public class TransportGoAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
